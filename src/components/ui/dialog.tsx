...
function DialogTitle({
  ...
  return (
    <DialogPrimitive.Title
      ...
      // §CLOSE-BUTTON UX — keep titles clear of the absolute close
      // button (top-4 end-4): inline-end padding reserves its lane so
      // long Arabic titles wrap instead of running under the ✕.
      className={cn("text-lg leading-none font-semibold pe-8", className)}
      {...props}
    />
  )
}
