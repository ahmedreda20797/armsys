...
"[project]/src/app/api/travel/route.ts [app-route] (ecmascript)", ((__turbopack_context__) => {
"use strict";
...
async function GET() {
    try {
        ...
        const employeeIds = [
            ...new Set(travelDeals.map((d)=>d.employeeId))
        ];
        ...
        const result = travelDeals.map((d)=>{
...
async function POST(request) {
    try {
        ...
        const { employeeId, destination, departureDate, returnDate, dealerName, customerNames, hasFlight, hasHotel, hasVisa, hasTours, hasTransportation, flightStatus, hotelStatus, visaStatus, toursStatus, transportationStatus, notes, status } = body;
        if (!employeeId || !destination || !departureDate) {
            return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json({
                error: 'Employee ID, destination, and departure date are required'
            }, {
                status: 400
            });
        }
        const travelDeal = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].travelDeal.create({
            data: {
                employeeId,
                destination,
                departureDate,
        ...
        return __TURBOPACK__imported__module__$5b$project$5d2f$node_modules$2f$next$2f$server$2e$js__$5b$app$2d$route$5d$__$28$ecmascript$29$__["NextResponse"].json(travelDeal, {
            status: 201
        });
    } catch (error) {
...
//# sourceMappingURL=%5Broot-of-the-server%5D__07fac3w._.js.map