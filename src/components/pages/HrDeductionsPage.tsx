                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                        <div className="flex-1">
                          <div className="flex items-center gap-3 mb-2 flex-wrap">
                            <span className="text-white font-medium">{ded.employeeName}</span>
                            <Badge className="bg-slate-600/40 text-slate-300 border-slate-500/30">{ded.type}</Badge>
                            <span className="text-emerald-400 font-semibold text-sm" dir="ltr">
                ...
                <Table>
                  ...
                  <TableBody>
                    {other.map((ded) => (
                      ...
                      >
                        <TableCell className="text-white font-medium">{ded.employeeName}</TableCell>
