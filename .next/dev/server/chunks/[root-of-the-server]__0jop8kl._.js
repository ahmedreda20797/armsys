...
async function GET(request) {
    try {
        ...
        const attendance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].attendance.findMany({
            where: whereClause,
            orderBy: {
                createdAt: 'desc'
            },
...
async function POST(request) {
    try {
        ...
        const attendance = await __TURBOPACK__imported__module__$5b$project$5d2f$src$2f$lib$2f$db$2e$ts__$5b$app$2d$route$5d$__$28$ecmascript$29$__["db"].attendance.create({
            data: {
                employeeId,
                date,
...
//# sourceMappingURL=%5Broot-of-the-server%5D__0jop8kl._.js.map