                  ...
                  <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 gap-2">
                    {syncResult.employees !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        ...
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.employees}</span>
                      </div>
                    )}
                    {syncResult.attendance !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">الحضور</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.attendance}</span>
                      </div>
                    )}
                    {syncResult.requests !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">الطلبات</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.requests}</span>
                      </div>
                    )}
                    {syncResult.rules !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">القواعد</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.rules}</span>
                      </div>
                    )}
                    {syncResult.quality !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">الجودة</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.quality}</span>
                      </div>
                    )}
                    {syncResult.travel !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">السفر</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.travel}</span>
                      </div>
                    )}
                    {syncResult.biometric !== undefined && (
                      <div className="flex items-center justify-between p-2 rounded bg-slate-800/50 border border-slate-700/30">
                        <span className="text-slate-400 text-xs">البصمة</span>
                        <span className="text-emerald-400 text-sm font-mono" dir="ltr">{syncResult.biometric}</span>
                      </div>
                    )}
                  </div>
                </motion.div>
