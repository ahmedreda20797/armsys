                    ...
                    <SidebarTooltip label={page.title}>
                      <motion.button
                        ...
                        className={cn(
                          ...
                          isActive
                            ? 'bg-indigo-600/90 text-white shadow-lg shadow-emerald-900/40'
                      ...
                      >
                        ...
                        {isActive && (
                          <motion.div
                            className="absolute right-0 top-1/2 -translate-y-1/2 w-1 h-6 rounded-l-full bg-amber-600"
            ...
            return (
              ...
              >
                ...
                >
                  ...
                  {isActive && (
                    <motion.div
                      className="mr-auto w-1.5 h-1.5 rounded-full bg-amber-600"
