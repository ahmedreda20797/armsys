...
```javascript
useCreateDepartment(options?: useDataConnectMutationOptions<CreateDepartmentData, FirebaseError, CreateDepartmentVariables>): UseDataConnectMutationResult<CreateDepartmentData, CreateDepartmentVariables>;
```
You can also pass in a `DataConnect` instance to the Mutation hook function.
```javascript
useCreateDepartment(dc: DataConnect, options?: useDataConnectMutationOptions<CreateDepartmentData, FirebaseError, CreateDepartmentVariables>): UseDataConnectMutationResult<CreateDepartmentData, CreateDepartmentVariables>;
```
...
```javascript
import { getDataConnect } from 'firebase/data-connect';
import { connectorConfig, CreateDepartmentVariables } from '@dataconnect/generated';
...
export default function CreateDepartmentComponent() {
  ...
  // The `useCreateDepartment` Mutation requires an argument of type `CreateDepartmentVariables`:
  const createDepartmentVars: CreateDepartmentVariables = {
    name: ..., 
    managerName: ..., 
    officeLocation: ..., // optional
  };
  mutation.mutate(createDepartmentVars);
  // Variables can be defined inline as well.
  mutation.mutate({ name: ..., managerName: ..., officeLocation: ..., });

  // You can also pass in a `useDataConnectMutationOptions` object to `UseMutationResult.mutate()`.
  const options = {
    onSuccess: () => { console.log('Mutation succeeded!'); }
  };
  mutation.mutate(createDepartmentVars, options);
...
export default function CreateEmployeeComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ fullName: ..., email: ..., position: ..., joinDate: ..., });
...
export default function CreateOrderComponent() {
  ...
  // Variables can be defined inline as well.
  mutation.mutate({ title: ..., status: ..., priority: ..., });
